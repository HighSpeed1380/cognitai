...
class PopupMenu {
  ...
  void show({Rect? rect, GlobalKey? widgetKey, List<MenuItemProvider>? items}) {
    ...
    _screenSize = View.of(buildContext).physicalSize /
        View.of(buildContext).devicePixelRatio;
  ...
  double get screenWidth {
    double width = View.of(buildContext).physicalSize.width;
    double ratio = View.of(buildContext).devicePixelRatio;
    return width / ratio;
  }
